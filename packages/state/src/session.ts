...
import type { InstanceContext } from "@opencode-ai/core/effect/instance-state"
...
import type { Model as ProviderModel } from "@opencode-ai/core/provider/provider"
...
export const getUsage = (input: { model: ProviderModel; usage: Usage; metadata?: ProviderMetadata }) => {
